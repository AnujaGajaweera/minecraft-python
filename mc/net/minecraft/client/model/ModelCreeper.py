...
class ModelCreeper(ModelBase):
    ...
    def __init__(self):
        ...
        self.__unusedCreeperHeadwear = ModelRenderer(32, 0)
        self.__unusedCreeperHeadwear.addBox(-4.0, -8.0, -4.0, 8, 8, 8, 0.5)
        self.__unusedCreeperHeadwear.setRotationPoint(0.0, 4.0, 0.0)
